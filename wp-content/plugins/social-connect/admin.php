...
function sc_register_social_connect_settings() {
	register_setting( 'social-connect-settings-group', 'social_connect_can_register_enabled' );
...
function sc_render_social_connect_settings() {
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<h3><?php _e('User Register Settings', 'social_connect'); ?></h3>
			<table class="form-table">
				<tr valign="top">
					<th scope="row"><?php _e('Enable?', 'social_connect'); ?></th>
					<td>
						<input type="checkbox" name="social_connect_can_register_enabled" value="1" <?php checked(get_option('social_connect_can_register_enabled', 1 ), 1 ); ?> /><br/>
						<?php _e('Check this box to allow new registration with Social Connect.', 'social_connect'); ?>
					</td>
				</tr>
			</table>
